...
jQuery(function($) {
    ...
    $(".adddetail").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "admin.php?c=prodetail&a=lists",
    ...
    $(".add_detail").click(function(){
        ...
        if(parent_id && detail_arr && total_amount > 0){
            ...
            $.ajax({
                ...
                url: "admin.php?c=prodetail&a=add2",
                dataType: "json",
                success: function(data) {
                    if(data.code == 0){
...
//    })
    ...
    $(".detail_del2").click(function(){
        ...
        if(confirm("确定要删除该条数据吗？") == true){
            ...
            $.ajax({
                ...
                url: "admin.php?c=prodetail&a=del",
                dataType: "json",
                success: function(data) {
    ...
    $(".add_title").click(function(){
        ...
        var num = $("#form04").find(".form-title:last").find("i").html();
        if(num == 5){
            alert("最多添加五条！！！");
            return false;
        }else{
            num = parseInt(num) + 1;
            var html = '';
            html = '<div class="form-group form-title">'+
                ...
                '</div>'+
                '</div>';
            $("#form04").find(".form-title:last").after(html);
        }
    })
...
//    }
    ...
    if(r == true){
        ...
        $.ajax({
            ...
            url: "admin.php?c=project_index&a=examine",
            dataType: "json",
            success: function(data) {
                if(data.code == 0){
                    if(type == '4'){
                        // window.location.reload();
                        window.location.href="admin.php?c=project_index&a=viewuseramortization&edit_id="+ project_id;
                    }else{
                        window.location.reload();
                    }
                }else{
    ...
    //审核
    function enterpriseExamine(project_id,type,total_amount){
        ...
        if(r == true){
            ...
            $.ajax({
                type: "POST",
                data:{ "project_id":project_id,"type":type},
                url: "admin.php?c=project_index&a=enterpriseExamine",
                dataType: "json",
                success: function(data) {
                    if(data.code == 0){
                        if(type == '4'){
